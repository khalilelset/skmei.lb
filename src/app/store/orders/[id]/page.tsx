...
const STATUS_CONFIG: Record<string, {
  ...
  pending: {
    Icon: Clock,
    bg: 'bg-yellow-400', ring: 'border-yellow-400/30', shadow: 'shadow-yellow-400/25', ping: 'border-yellow-400/30',
  ...
  confirmed: {
    Icon: CheckCircle2,
    bg: 'bg-blue-500', ring: 'border-blue-500/30', shadow: 'shadow-blue-500/25', ping: 'border-blue-500/30',
    text: 'text-blue-400',
  ...
  processing: {
    Icon: Package,
    bg: 'bg-purple-500', ring: 'border-purple-500/30', shadow: 'shadow-purple-500/25', ping: 'border-purple-500/30',
  ...
  shipped: {
    Icon: Truck,
    bg: 'bg-indigo-500', ring: 'border-indigo-500/30', shadow: 'shadow-indigo-500/25', ping: 'border-indigo-500/30',
  ...
  delivered: {
    Icon: CheckCircle2,
    bg: 'bg-green-500', ring: 'border-green-500/30', shadow: 'shadow-green-500/25', ping: 'border-green-500/30',
    text: 'text-green-400',
    title: 'Delivered!',
