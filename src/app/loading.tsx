  ...
  return (
    <div className="fixed inset-0 z-9999 flex flex-col items-center justify-center bg-brand-black overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 h-0.5 overflow-hidden">
        <div className="h-full w-1/2 bg-linear-to-r from-transparent via-brand-red to-transparent animate-loader-bar" />
      </div>
      ...
      {/* Bottom bar */}
      <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-linear-to-r from-transparent via-brand-red/40 to-transparent" />
    </div>
  );
}
