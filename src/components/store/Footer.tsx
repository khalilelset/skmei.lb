        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="p-2 bg-white/10 hover:bg-brand-red rounded-full transition-colors"
              aria-label="Facebook"
            >
              <svg
          ...
          {/* Copyright with animated ping dot */}
          <p className="text-sm text-brand-gray-light flex items-center gap-2">
